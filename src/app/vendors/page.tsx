...
export default async function VendorsPage({
  ...
  const finishKeys = new Set(FINISH_STYLES.map((f) => f.key as string));
  ...
  const filters: VendorFilters = {
    ...
    technique: pick(one(sp.technique), techKeys),
    finish: pick(one(sp.finish), finishKeys),
    minFaces: int(one(sp.faces)),
